...
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          <li>
            <a href="<?php echo site_url("login/klik_login"); ?>"><i class="glyphicon glyphicon-log-out"></i> Log In</a>
          </li>
          <li>
            <a href="<?php echo site_url("daftar"); ?>"><i class="fa fa-fw fa-user"></i> Sign Up</a>
          </li>
        </ul>
      </div>
    </nav>
 ...
 <div class="content-wrapper">
    ...
    <?php foreach ($produk as $brg): ?>
      <img style="width:200px;height:200px;margin-left: 10%; margin-top: 5%; float: center;" src="<?php echo base_url('assets/img/vendor/barang/'.$brg->foto_barang) ?>" />
    <?php endforeach; ?>
    </div>
